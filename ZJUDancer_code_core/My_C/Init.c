...
void Load_tx_buff_u1(void)
{
	...
	tx_buff_u1[16] = magnraw_adis[0];
	tx_buff_u1[17] = magnraw_adis[1];
	tx_buff_u1[18] = magnraw_adis[2];
	tx_buff_u1[19] = magnraw_adis[3];
	tx_buff_u1[20] = magnraw_adis[4];
	tx_buff_u1[21] = magnraw_adis[5];
